...
First create a DB of the representative plass protein (named plass_proteins_rep) and then used mmseqs2 search agains the eggNOG DB (run_mmseqs_search.sbatch)
```
